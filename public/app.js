...
const BADGES = [
  { name: 'Iniciante', icon: '🔰', desc: 'Registrou a primeira captura.', rarity: 'Comum', condition: (stats) => stats.catchCount >= 1 },
  { name: 'Pescador Casual', icon: '🎣', desc: 'Registrou 10 capturas.', rarity: 'Comum', condition: (stats) => stats.catchCount >= 10 },
  { name: 'Pescador Experiente', icon: '🐟', desc: 'Registrou 50 capturas.', rarity: 'Incomum', condition: (stats) => stats.catchCount >= 50 },
  { name: 'Mestre Pescador', icon: '🏆', desc: 'Registrou 100 capturas.', rarity: 'Raro', condition: (stats) => stats.catchCount >= 100 },
  { name: 'Lenda da Pesca', icon: '🌟', desc: 'Registrou 250 capturas.', rarity: 'Épico', condition: (stats) => stats.catchCount >= 250 },
  { name: 'Deus da Pesca', icon: '🔱', desc: 'Registrou 500 capturas.', rarity: 'Lendário', condition: (stats) => stats.catchCount >= 500 },
  { name: 'Primeiro Quilo', icon: '⚖️', desc: 'Capturou um total de 1kg de peixes.', rarity: 'Comum', condition: (stats) => stats.totalWeight >= 1 },
  { name: 'Peso Pesado', icon: '🏋️', desc: 'Capturou um total de 50kg de peixes.', rarity: 'Incomum', condition: (stats) => stats.totalWeight >= 50 },
  { name: 'Gigante das Águas', icon: '🐋', desc: 'Capturou um total de 200kg de peixes.', rarity: 'Raro', condition: (stats) => stats.totalWeight >= 200 },
  { name: 'Monstro do Lago', icon: '🐉', desc: 'Capturou um peixe com mais de 10kg.', rarity: 'Épico', condition: (stats) => stats.maxWeight >= 10 },
  { name: 'Pescador Noturno', icon: '🌙', desc: 'Registrou uma captura entre 18h e 6h.', rarity: 'Incomum', condition: (stats) => stats.hasNightCatch },
  { name: 'Madrugador', icon: '☀️', desc: 'Registrou uma captura entre 5h e 8h.', rarity: 'Incomum', condition: (stats) => stats.hasEarlyBirdCatch },
  { name: 'Variedade', icon: '🐠', desc: 'Capturou 5 espécies diferentes.', rarity: 'Raro', condition: (stats) => stats.uniqueSpecies >= 5 },
  { name: 'Colecionador', icon: '🐡', desc: 'Capturou 10 espécies diferentes.', rarity: 'Épico', condition: (stats) => stats.uniqueSpecies >= 10 },
  { name: 'Consistência', icon: '🗓️', desc: 'Pescou em 3 dias diferentes.', rarity: 'Incomum', condition: (stats) => stats.daysFished >= 3 },
  { name: 'Hábito', icon: '📅', desc: 'Pescou em 7 dias diferentes.', rarity: 'Raro', condition: (stats) => stats.daysFished >= 7 },
];
